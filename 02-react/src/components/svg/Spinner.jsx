        ...
        <div className="spinnner">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
                <radialGradient id="a12" cx=".66" fx=".66" cy=".3125" fy=".3125" gradientTransform="scale(1.5)">
                    ...
                    <stop offset=".3" stopColor="#94A3B8" stopOpacity=".9"></stop>
                    <stop offset=".6" stopColor="#94A3B8" stopOpacity=".6"></stop>
                    <stop offset=".8" stopColor="#94A3B8" stopOpacity=".3"></stop>
                    <stop offset="1" stopColor="#94A3B8" stopOpacity="0"></stop>
                </radialGradient>
                <circle transformOrigin="center" fill="none" stroke="url(#a12)" strokeWidth="15"
                ...
                <circle transformOrigin="center" fill="none" opacity=".2" stroke="#94A3B8" strokeWidth="15"
